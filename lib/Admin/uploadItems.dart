...
class _UploadPageState extends State<UploadPage>
  ...
  Widget build(BuildContext context) {
    return file == null ? displayAdminHomeScreen() : dispalyAdminUploadFormScreen();
  ...
  dispalyAdminUploadFormScreen() {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          FlatButton(
            onPressed: uploading ? null : () => uploadingImageAndSaveItemInfo(),
            child: Text(
              "Add",
              style: TextStyle(
                  color: Colors.pink,
  ...
  uploadingImageAndSaveItemInfo() async
  {
   ...
   String imageDownloadUrl = await uploadingItemImage(file);
   saveItemInfo(imageDownloadUrl);
  }
  Future<String>  uploadingItemImage(mFileImage) async{
    final StorageReference storageReference = FirebaseStorage.instance.ref().child("Item");
